...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'vendorx-ecommerce-admin.Site.Service.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('vendorx-ecommerce-admin.Site.Service.refresh', callback);
		},
		onServicesSelected: function(callback) {
			on('vendorx-ecommerce-admin.Site.Services.selected', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v3/js/vendorx-ecommerce-admin/api/Site/Service.js';
