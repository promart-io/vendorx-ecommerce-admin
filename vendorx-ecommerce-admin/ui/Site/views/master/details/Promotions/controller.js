...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'vendorx-ecommerce-admin.Site.Promotions.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('vendorx-ecommerce-admin.Site.Promotions.refresh', callback);
		},
		onIndexSelected: function(callback) {
			on('vendorx-ecommerce-admin.Site.Index.selected', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v3/js/vendorx-ecommerce-admin/api/Site/Promotions.js';
