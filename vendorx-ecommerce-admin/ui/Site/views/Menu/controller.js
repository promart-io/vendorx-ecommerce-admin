...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'vendorx-ecommerce-admin.Site.Menu.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('vendorx-ecommerce-admin.Site.Menu.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../services/v3/js/vendorx-ecommerce-admin/api/Site/Menu.js';
