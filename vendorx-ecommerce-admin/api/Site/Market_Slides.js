...
var dao = require('vendorx-ecommerce-admin/data/dao/Site/Market_Slides');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Market_Slides not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/vendorx-ecommerce-admin/api/Market_Slides.js/' + entity.Id);
