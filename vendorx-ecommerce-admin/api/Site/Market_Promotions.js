...
var dao = require('vendorx-ecommerce-admin/data/dao/Site/Market_Promotions');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Market_Promotions not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/vendorx-ecommerce-admin/api/Market_Promotions.js/' + entity.Id);
