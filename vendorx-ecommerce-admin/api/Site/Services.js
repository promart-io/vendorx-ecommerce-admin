...
var dao = require('vendorx-ecommerce-admin/data/dao/Site/Services');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/vendorx-ecommerce-admin/api/Services.js/' + entity.Id);
