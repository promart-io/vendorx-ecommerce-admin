...
var dao = require('vendorx-ecommerce-admin/data/dao/Nomenclatures/UoM');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/vendorx-ecommerce-admin/api/UoM.js/' + entity.Id);
