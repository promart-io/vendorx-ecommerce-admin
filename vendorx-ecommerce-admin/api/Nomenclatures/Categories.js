...
var dao = require('vendorx-ecommerce-admin/data/dao/Nomenclatures/Categories');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/vendorx-ecommerce-admin/api/Categories.js/' + entity.Id);
